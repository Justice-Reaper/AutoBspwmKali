...
sed -i "s/adapter = adapter_replace/adapter = $adapter/g" $directorio_instalacion/polybar/* &>/dev/null
sed -i "s/battery = battery_replace/battery = $battery/g" $directorio_instalacion/polybar/* &>/dev/null
