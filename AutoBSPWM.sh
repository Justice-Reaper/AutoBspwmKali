...
sed -i "s/adapter_replace/$input_username/g" $directorio_instalacion/polybar/* &>/dev/null
sed -i "s/battery_replace/$input_username/g" $directorio_instalacion/polybar/* &>/dev/null
