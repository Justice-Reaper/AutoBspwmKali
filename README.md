...
<kbd>Windows</kbd> + <kbd>Shift</kbd> + <kbd>S</kbd> : Open Rofi scope manager  

## Window Shortcuts
<kbd>Windows</kbd> + <kbd>Alt</kbd> + <kbd>(⬆⬅⬇➡)</kbd> : Expand window
<kbd>Windows</kbd> + <kbd>Alt</kbd> + <kbd>Shift</kbd> + <kbd>(⬆⬅⬇➡)</kbd> : Contract window  
...
<kbd>Windows</kbd> + <kbd>Shift</kbd> + <kbd>E</kbd> : Open Pycharm    
...
<kbd>enable-touchpad</kbd> : Enable the laptop's touchpad    
<kbd>disable-touchpad</kbd> : Disable the laptop's touchpad  

<kbd>set-wallpaper</kbd> : Set a wallpaper    

<kbd>extract-ports</kbd> : Extract ports from a file in nmap -oG format and copy them to the clipboard    
...
<kbd>kali-optimus</kbd> : Automates repository repair, GPG fixes, full system upgrade and cleanup  
