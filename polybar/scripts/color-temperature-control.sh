...
color_temperature_kelvin_file=/home/user_replace/.config/bin/color-temperature-kelvin
color_temperature_kelvin=$(cat $color_temperature_kelvin_file)

color_temperature_percentage_file=/home/user_replace/.config/bin/color-temperature-percentage
color_temperature_percentage=$(cat $color_temperature_percentage_file)

redshift_status_file=/home/user_replace/.config/bin/redshift-status
